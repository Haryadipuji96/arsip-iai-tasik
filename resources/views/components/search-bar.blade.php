<form action="{{ route($route) }}" method="GET" class="mb-4" x-data="{ loading: false }" @submit="loading = true">
    <div class="relative w-full" id="input">
        <!-- Input search -->
        <input type="text" name="search" value="{{ request('search') }}" id="floating_outlined" placeholder="Search..."
        ...
        <!-- Loader animasi baru -->
        <div x-show="loading" class="absolute bottom-0 left-0 w-full flex justify-center mt-1">
            <!-- Loader SVG -->
