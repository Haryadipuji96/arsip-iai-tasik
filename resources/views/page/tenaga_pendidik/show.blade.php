        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
                ...
                <div class="p-6">
                    ...
                    <!-- File -->
                    <div class="mt-4">
                        <h3 class="text-lg font-semibold text-gray-800 mb-3">File Dokumen</h3>
                        @if ($tenagaPendidik->file_url)
                            <a href="{{ $tenagaPendidik->file_url }}" target="_blank"
                                class="inline-flex items-center px-3 py-2 bg-green-100 text-green-800 rounded-full text-sm font-medium hover:bg-green-200 transition">
