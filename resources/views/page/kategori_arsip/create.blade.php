...
<head>
    ...
    <title>Tambah Kategori Arsip</title>
                ...
                <div class="bg-white shadow-xl rounded-2xl p-4 sm:p-6 md:p-8 w-full border border-gray-100">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 pb-4 border-b">
                        <div class="flex items-center space-x-3 mb-3 sm:mb-0">
                            ...
                            <h1 class="text-xl sm:text-2xl font-semibold text-gray-800">Tambah Kategori Arsip</h1>
                        </div>
                    ...
                    <form action="{{ route('kategori-arsip.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label class="block font-medium mb-1 text-sm sm:text-base">Nama Kategori</label>
                            <input type="text" name="nama_kategori" class="w-full border rounded px-3 py-2 text-sm sm:text-base" required
