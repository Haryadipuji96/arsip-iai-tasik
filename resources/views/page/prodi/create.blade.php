                ...
                <div class="bg-white shadow-xl rounded-2xl p-4 sm:p-6 md:p-8 w-full border border-gray-100">
                    ...
                    <form action="{{ route('prodi.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="id_fakultas" class="w-full border rounded px-3 py-2 text-sm sm:text-base" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_prodi" class="w-full border rounded px-3 py-2 text-sm sm:text-base" required
                                placeholder="Masukkan nama program studi">
                        </div>

                        <div class="mb-4">
                            <label class="block font-medium mb-1 text-sm sm:text-base">Jenjang</label>
                            <input type="text" name="jenjang" class="w-full border rounded px-3 py-2 text-sm sm:text-base"
